...
<head>
  ...
  <style>
    ...
    header p { margin: 0; }
    .collage { display: flex; justify-content: space-around; margin: 10px; }
    .collage img { width: 100px; height: 70px; background: #aaa; }
    ...
    .item img { width: 80px; height: 60px; background: #aaa; }
    .texto { flex: 1; }
  </style>
</head>
<body>
